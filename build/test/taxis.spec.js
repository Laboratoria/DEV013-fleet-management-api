...
describe('GET /taxis', () => {
    it('should respond with JSON array of taxis', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(index_1.default).get('/taxis');
